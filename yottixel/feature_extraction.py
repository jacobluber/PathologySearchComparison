...
def extract_features(patch_dir, extracted_features_save_adr, network_weights_address, network_input_patch_width, batch_size, img_format):
    ...
    for batch_st_ind in tqdm(range(0, len(patch_adr_list), batch_size)):
        ...
        patch_batch = np.array([io.imread(x) for x in batch_patch_adr_list])
...
parser.add_argument('--extracted_features_save_adr', default='./extracted_features.pickle', help='Address to save extracted features')
...
parser.add_argument('--img_format', default='jpg', help='Image format')
...
if __name__ == "__main__":
    ...
    extract_features(args.patch_dir, args.extracted_features_save_adr, args.network_weights_address, args.network_input_patch_width, args.batch_size, args.img_format)
