...
def save_results(query_slides, extension, site, experiment, codebook_semantic="checkpoints/codebook_semantic.pt",
    ...
    database_index_path = join(DATA_DIR, "ABLATION_DATABASES", site, "index_tree", "veb.pkl")
    index_meta_path = join(DATA_DIR, "ABLATION_DATABASES", site, "index_meta", "meta.pkl")
...
if __name__ == "__main__":
    ...
    for site in sites:
        ...
        save_results(query_slides, extension=extension, site=site, experiment=experiment)
